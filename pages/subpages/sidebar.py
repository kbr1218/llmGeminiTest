...
def show_sidebar():
  ...
  if 'age' in st.session_state:
      ...
      st.sidebar.warning("연령대 정보가 입력되지 않았습니다.", icon=":material/warning:")
